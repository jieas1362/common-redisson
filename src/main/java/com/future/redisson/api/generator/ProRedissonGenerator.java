package com.future.redisson.api.generator;
...
import static com.future.redisson.constant.ServerMode.CLUSTER;
import static com.future.redisson.constant.ServerMode.SINGLE;
...
public final class ProRedissonGenerator {

    private static final Logger LOGGER = LoggerFactory.getLogger(ProRedissonGenerator.class);
